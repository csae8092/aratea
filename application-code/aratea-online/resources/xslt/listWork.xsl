                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            <xsl:choose>
                                <xsl:when test="//work[@xml:id=$entiyID][@ref]">
                                    <xsl:element name="a">
                                        <xsl:attribute name="href">
                                            <xsl:value-of select="//work[@xml:id=$entiyID]/@ref"/>
                                        </xsl:attribute>
                                        <xsl:value-of select="//work[@xml:id=$entiyID]/title/text()"/>
                                    </xsl:element>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:value-of select="//work[@xml:id=$entiyID]/title/text()"/>
                    ...
                    <div class="modal-body">
                        <table class="table table-boardered table-hover">
                            <xsl:for-each select="//work[@xml:id=$entiyID]/*[text()]">
                                <tr>
                                    <th>
