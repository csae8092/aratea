...
import module namespace config="http://www.digital-archiv.at/app/aratea-online/config" at "modules/config.xqm";

let $target-base-default := "C:/Users/pandorfer/ownCloud/GIT/Redmine/aratea/application-code"
